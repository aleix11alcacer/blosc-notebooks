...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_tData0(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_tData0(void) { return NULL; }
#  else
     inittData0(void) { }
#  endif
#  endif
...
PyInit_tData0(void)
{
  return _cffi_init("tData0", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
inittData0(void)
{
  _cffi_init("tData0", 0x2601, &_cffi_type_context);
}
#endif
