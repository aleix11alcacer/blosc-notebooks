...
int c_j(size_t k, size_t dim[], size_t shp[], size_t sub[]) {
...
int c_i(size_t j, size_t shp[], size_t sho[], size_t sub[]) {
...
int c_cond(size_t k, size_t c, size_t sho[], size_t sub[]) {
...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 10), // void()(char *, char *, size_t, size_t *, size_t *, size_t, size_t)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 9), // char *
/*  2 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  3 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 28), // size_t
/*  4 */ _CFFI_OP(_CFFI_OP_POINTER, 3), // size_t *
...
static void _cffi_d_tData_general(char * x0, char * x1, size_t x2, size_t * x3, size_t * x4, size_t x5, size_t x6)
{
  tData_general(x0, x1, x2, x3, x4, x5, x6);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_tData_general(PyObject *self, PyObject *args)
{
  char * x0;
  char * x1;
  size_t x2;
  ...
  if (!PyArg_UnpackTuple(args, "tData_general", 7, 7, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6))
    return NULL;
...
#else
#  define _cffi_f_tData_general _cffi_d_tData_general
#endif
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "tData", (void *)_cffi_f_tData, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_tData },
  { "tData_general", (void *)_cffi_f_tData_general, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_tData_general },
  { "tData_simple", (void *)_cffi_f_tData_simple, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_tData_simple },
};
