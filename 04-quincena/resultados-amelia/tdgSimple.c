...
static void _cffi_d_transform_data(char * x0, char * x1, size_t x2, size_t * x3, size_t * x4, size_t x5, size_t x6)
{
  transform_data(x0, x1, x2, x3, x4, x5, x6);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_transform_data(PyObject *self, PyObject *args)
{
  char * x0;
  char * x1;
  size_t x2;
  ...
  if (!PyArg_UnpackTuple(args, "transform_data", 7, 7, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6))
    return NULL;
...
#else
#  define _cffi_f_transform_data _cffi_d_transform_data
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "transform_data", (void *)_cffi_f_transform_data, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_transform_data },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_tdgSimple(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_tdgSimple(void) { return NULL; }
#  else
     inittdgSimple(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_tdgSimple(void)
{
  return _cffi_init("tdgSimple", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
inittdgSimple(void)
{
  _cffi_init("tdgSimple", 0x2601, &_cffi_type_context);
}
#endif
